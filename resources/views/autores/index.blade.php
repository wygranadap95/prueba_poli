...
<body>
    <h3 id="titulo">Registro Autores</h1>
            ...
            <table class="table table-hover" id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$arreT['identificacion']}}</td>
                        <td>{{$arreT['nombre']}}</td>
                        <td>{{$arreT['apellido']}}</td>
                        <td>
            ...
            $.ajax({
                ...
                success: function(rsp) {
                    ...
                    if (rsp == 'ok') {
                        ...
                        setTimeout("location.reload(true);", 150);
                    } else if (rsp == 'repetido') {
                        Swal.fire({
                            title: 'Error!',
                            text: 'Numero de Cedula ya existe',
                            type: 'error',
                            confirmButtonText: 'Cerrar'
                        });
                        $("#identificacion").val('');
